...
const FloatingCTA = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {isOpen && (
        <div className="bg-card border border-border rounded-2xl shadow-luxury p-5 w-72 animate-fade-up">
          ...
          <div className="space-y-2">
            <a
              ...
              className="flex items-center gap-3 w-full p-3 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-white font-semibold text-sm transition-all duration-300 hover:-translate-y-0.5"
            >
            ...
            <a
              ...
              className="flex items-center gap-3 w-full p-3 rounded-xl bg-primary hover:bg-primary-glow text-primary-foreground font-semibold text-sm transition-all duration-300 hover:-translate-y-0.5"
            >
